 ...
 * @author User
 */
public class Question_7_denomination_moduler { // to define public class
    ...
    public static void main(String[] args) { //to define main method and program will start from here.
        ...
        if (choice == 1) {//to check that user chose the option 1
