    ...
    public void menuOption1() {
        for (int i = 0; i < accounts.length; i++) {
            ...
            if (accounts[i] != null) {
                ...
                System.out.println("Full Name: " +accounts[i].getCustomer().getFirstName()+" "+
    ...
    public void menuOption2() {
        ...
        for (int i = 0; i < accounts.length; i++) {
            ...
            if (accounts[i] != null && accounts[i].getAccountNumber() == id) {
                System.out.println("Account Number: " + accounts[i].getAccountNumber());
                System.out.println(accounts[i].getCustomer().toString());
                System.out.printf("Account Balance: %.2f", accounts[i].getBalance());//to print dollar balance upto 2 decimal point
                System.out.println("\nLast Transaction: " + accounts[i].getLastTransaction());
                found = true;
            }
    ...
    public void menuOption3() {
        ...
        for (int i = 0; i < accounts.length; i++) {
            if (accounts[i] != null) {
                ...
                System.out.println((i + 1) + "." + accounts[i].getAccountNumber() + ", " + accounts[i].getCustomer().toString());
            } else {
        ...
        if(choice2==1) {
            ...
            accounts[choice-1].getCustomer().setCustomerId(input.nextInt());
        } else if (choice2 == 2) {
            System.out.print("Enter new first name: ");
            accounts[choice - 1].getCustomer().setFirstName(input.next());
            System.out.println("First name updated.");
        } else if (choice2 == 3) {
            System.out.print("Enter new last name: ");
            accounts[choice - 1].getCustomer().setLastName(input.next());
            System.out.println("Last name updated.");
        } else if (choice2 == 4) {
            System.out.print("Enter new middle initial: ");
            accounts[choice - 1].getCustomer().setMiddleInit(input.next().charAt(0));
 ...
 */
    public void menuOption4() {
        ...
        for (int i = 0; i < accounts.length; i++) {
            if (accounts[i] != null && accounts[i].getAccountNumber() == id) {
                ...
                Date depositDate = new Date(year, month, day);
    ...
    public void menuOption5() {
        ...
        for (int i = 0; i < accounts.length; i++) {
            if (accounts[i] != null && accounts[i].getAccountNumber() == id) {
                ...
                Date withdrawalDate = new Date(year, month, day);
    ...
    public void menuOption6() {
        ...
        if (sender != null && receiver != null) {
            ...
            System.out.print("Enter Year: ");
            int year = input.nextInt();
            Date transferDate = new Date(year, month, day);
        ...
        // to take Year Month Day in a single prompt
        System.out.print("Date (Year Month Day): ");
        Date lastTransaction = new Date(input.nextInt(), 
                                        input.nextInt(), 
                                        input.nextInt());
        Customer newCustomer = new Customer(customerId, firstName, lastName, middleInIt);
