...
public class BankAccountDriver {
    ...
    public void getData() {
        ...
        accounts[1] = new BankAccount(1002, "Md Alamgir", "Hossain", 'A', 6400.20f, new Date(13, 4, 2022));
        accounts[2] = new BankAccount(1003, "Moqsudul", "Hoque", 'M', 5576.57f, new Date(18, 1, 2022));
        accounts[3] = new BankAccount(1004, "Anish", "Chakma", 'A', 2200.15f, new Date(3, 2, 2021));
        accounts[4] = new BankAccount(1005, "Amara", "Butt", 'B', 36000.40f, new Date(8, 9, 2019));
    }
/**
 ...
 */
    public int showMenu() {
        ...
        System.out.println("--------------------------------");
        //to  call acceptNumberInBound method to return the number within bound
        return acceptNumberInBound("Please select an option between-", 1, 7);
    }
    ...
    public void executeChoices(int choice) {
        if (choice == 1) {
            ...
            System.out.println("Invalid choice, Please input from 1 to 7");
        }
    }
    /**
...
/**
 * this method will provide to sub menu to user 
 ...
 */
     ...
     * @param prompt text message to prompt
     * @param lower bound
     * @param upper bound
     * @return
     */
...
// I used do-while loop to display the all options once ever if the condition false
        do {
            ...
            // loop will exit when the user choice is exactly 7.
        } while (choice != 7);
